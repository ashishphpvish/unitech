                                        ...
                                        <ul class="list-unstyled order-list">
                                            <li class="avatar avatar-sm">
                                                <img class="rounded-circle"
                                                    src="{{ asset('admin/assets/images/user/user1.jpg') }}" alt="user">
                                            </li>
                                            <li class="avatar avatar-sm">
                                                <img class="rounded-circle"
                                                    src="{{ asset('admin/assets/images/user/user2.jpg') }}" alt="user">
                                            </li>
                                            <li class="avatar avatar-sm">
                                                <img class="rounded-circle"
                                                    src="{{ asset('admin/assets/images/user/user3.jpg') }}" alt="user">
                                            </li>
                                            <li class="avatar avatar-sm">
                    ...
                    <ul class="feedBody">
                        <li class="active-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user1.jpg') }}" class="img-radius "
                        ...
                        <li class="diactive-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user2.jpg') }}" class="img-radius "
                                    alt="User-Profile-Image">
                            </div>
                            <h6>
                        ...
                        <li class="diactive-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user3.jpg') }}" class="img-radius "
                                    alt="User-Profile-Image">
                            </div>
                            <h6>
                        ...
                        <li class="active-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user4.jpg') }}" class="img-radius "
                                    alt="User-Profile-Image">
                            </div>
                            <h6>
                        ...
                        <li class="active-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user5.jpg') }}" class="img-radius "
                                    alt="User-Profile-Image">
                            </div>
                            <h6>
                                <span class="feedLblStyle lblFileStyle">File</span> Sarah Smith
                        ...
                        <li class="diactive-feed">
                            <div class="feed-user-img">
                                <img src="{{ asset('admin/assets/images/user/user6.jpg') }}" class="img-radius "
                                    alt="User-Profile-Image">
                            </div>
                            <h6>
                                <span class="feedLblStyle lblTaskStyle">Task </span> Jalpa Joshi
